### Authored & edited by BCL with GPT-5 assistance - initial 8/19/2025, rev02e ###
...
$null = New-Item -ItemType Directory -Force -Path `     #Added to ensure that Log folders are created if they are initially missing - rev02c - BCL - 8/19/2025
    $PatchPath, `                                       #Added to ensure that Log folders are created if they are initially missing - rev02c - BCL - 8/19/2025a
    (Join-Path $BasePath 'PCs_Up'), `                   #Added to ensure that Log folders are created if they are initially missing - rev02c - BCL - 8/19/2025a
    (Join-Path $BasePath 'PCs_Patch_Copied')            #Added to ensure that Log folders are created if they are initially missing - rev02c - BCL - 8/19/2025a
