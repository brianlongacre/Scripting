...
#Export_Folder_path = Path("D:/Overflow - One Drive Filling up - Temporary/Projects/Cyber Security/Crowdstrike/Data Prep/" + date_str) # Remove Comment from this line to use Temporary Export redirection - Uncomment to use
Import_data_folder = Path(Import_Folder_path + "/" + date_str)
File_Ouptput_Prefix = "Daily Remediation Export - ALL - "
File_Output_Suffix = " - prepped.csv"
